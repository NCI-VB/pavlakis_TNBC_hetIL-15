tumor_d2_volcano <- function(Deg_tumor) {
...
print("template_function_tumor_d2_volcano.R #########################################################################")
...
var_tumor_d2_volcano<-tumor_d2_volcano(var_Deg_tumor)
invisible(graphics.off())
saveRDS(var_tumor_d2_volcano, paste0(rds_output,"/var_tumor_d2_volcano.rds"))
