lymph_d2_volcano_copied <- function(Deg_lymph) {
    #image:png
   ...
   # print(genesmat)
    ...
    #pointsize = 3
        ...
        png(
      filename="lymph_d2_volcano_copied.png",
      width=7,
      height=5,
      units="in",
      pointsize=4,
    ...
    p <- ggplot(genesmat,
        ...
        geom_point(
            ...
            size = pointsize) +
                geom_point(
            data = subset(genesmat, Gene %in% c("Ifng")), 
            color = 'green',
            size = pointsize) +
        geom_point(
...
print("template_function_lymph_d2_volcano_copied.R #########################################################################")
...
var_lymph_d2_volcano_copied<-lymph_d2_volcano_copied(var_Deg_lymph)
invisible(graphics.off())
saveRDS(var_lymph_d2_volcano_copied, paste0(rds_output,"/var_lymph_d2_volcano_copied.rds"))
