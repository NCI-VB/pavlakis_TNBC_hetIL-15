lymph_d2_volcano <- function(Deg_lymph) {
    #image:png
   ...
   # print(genesmat)
    ...
    p <- ggplot(genesmat,
        ...
        geom_point(
            ...
            size = pointsize) +
        # geom_text_repel(
        #     data = genesmat[genesmat$Gene %in% c("Ccl9","Cxcr3","Ccl19","Gzma","Gzmb","Ctsw","Klrg1","Prf1","Ifng"),], 
        #     label = genesmat[genesmat$Gene %in% c("Ccl9","Cxcr3","Ccl19","Gzma","Gzmb","Ctsw","Klrg1","Prf1","Ifng"),"Gene"], 
        #     color = "black",
        #     fontface = 1,
        #     segment.size = 0,
        #     nudge_x = nudge_x_all,
...
print("template_function_lymph_d2_volcano.R #########################################################################")
...
var_lymph_d2_volcano<-lymph_d2_volcano(var_Deg_lymph)
invisible(graphics.off())
saveRDS(var_lymph_d2_volcano, paste0(rds_output,"/var_lymph_d2_volcano.rds"))
