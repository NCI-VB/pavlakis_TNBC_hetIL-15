ADT_Scaled_Counts <- function(renamed_so) {
    ...
    df <- so@assays$Protein@scale.data
...
print("template_function_ADT_Scaled_Counts.R #########################################################################")
...
var_ADT_Scaled_Counts<-ADT_Scaled_Counts(var_renamed_so)
invisible(graphics.off())
saveRDS(var_ADT_Scaled_Counts, paste0(rds_output,"/var_ADT_Scaled_Counts.rds"))
