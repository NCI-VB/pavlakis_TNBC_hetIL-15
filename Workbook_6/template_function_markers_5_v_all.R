...
markers_5_v_all <- function(deg_cluster_vs_all) {
    # image: png
    ...
    label.col <- "Gene"
    sig.col <- "p_val_adj_5_vs_all"
    lfc.col <- "avg_logFC_5_vs_all"
...
print("template_function_markers_5_v_all.R #########################################################################")
...
var_markers_5_v_all<-markers_5_v_all(var_deg_cluster_vs_all)
invisible(graphics.off())
saveRDS(var_markers_5_v_all, paste0(rds_output,"/var_markers_5_v_all.rds"))
