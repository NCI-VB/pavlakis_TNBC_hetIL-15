...
deg_cluster_vs_all <- function(reclusterd_so,Sample_Names_Reclustered,deg_metadata) {
    ...
    contrasts <- c("0-all","1-all","2-all","3-all","4-all","5-all","6-all","7-all","8-all","9-all","10-all")
    useSpark <- FALSE
...
print("template_function_deg_cluster_vs_all.R #########################################################################")
...
var_deg_cluster_vs_all<-deg_cluster_vs_all(var_reclusterd_so,var_Sample_Names_Reclustered,var_deg_metadata)
invisible(graphics.off())
saveRDS(var_deg_cluster_vs_all, paste0(rds_output,"/var_deg_cluster_vs_all.rds"))
