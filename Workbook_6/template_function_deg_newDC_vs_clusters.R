...
deg_newDC_vs_clusters <- function(reclusterd_so,Sample_Names_Reclustered,deg_metadata) {
    ...
    contrasts <- c("4-0","4-1","4-2","4-3","4-5","4-6","4-7","4-8","4-9","4-10")
    useSpark <- FALSE
...
print("template_function_deg_newDC_vs_clusters.R #########################################################################")
...
var_deg_newDC_vs_clusters<-deg_newDC_vs_clusters(var_reclusterd_so,var_Sample_Names_Reclustered,var_deg_metadata)
invisible(graphics.off())
saveRDS(var_deg_newDC_vs_clusters, paste0(rds_output,"/var_deg_newDC_vs_clusters.rds"))
