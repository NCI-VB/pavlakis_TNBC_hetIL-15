...
deg_metadata <- function(reclusterd_so) {
...
print("template_function_deg_metadata.R #########################################################################")
...
var_deg_metadata<-deg_metadata(var_reclusterd_so)
invisible(graphics.off())
saveRDS(var_deg_metadata, paste0(rds_output,"/var_deg_metadata.rds"))
