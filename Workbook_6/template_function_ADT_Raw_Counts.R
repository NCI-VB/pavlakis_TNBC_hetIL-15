ADT_Raw_Counts <- function(renamed_so) {
...
print("template_function_ADT_Raw_Counts.R #########################################################################")
...
var_ADT_Raw_Counts<-ADT_Raw_Counts(var_renamed_so)
invisible(graphics.off())
saveRDS(var_ADT_Raw_Counts, paste0(rds_output,"/var_ADT_Raw_Counts.rds"))
