PCA_and_Elbow_Plots <- function(Postfilter_QC_Plots) {
    #image: png
    imageType = "png"
...
# auto removed:         #return(NULL)
  ...
  maxit = 1000))
   ...
   if (imageType == "png") {
    png(
      filename="PCA_and_Elbow_Plots.png",
      width=imageWidth,
      height=imageHeight,
      units="px",
      pointsize=4,
...
print("template_function_PCA_and_Elbow_Plots.R #########################################################################")
...
var_PCA_and_Elbow_Plots<-PCA_and_Elbow_Plots(var_Postfilter_QC_Plots)
invisible(graphics.off())
saveRDS(var_PCA_and_Elbow_Plots, paste0(rds_output,"/var_PCA_and_Elbow_Plots.rds"))
