F6f_tmm_2d_pca <- function(DC_CPM_TMM_FILTERED, DC_metadata){
    # image: png
    ...
    #   geom_text(data=labelpos, aes(x=mean_x, y=mean_y, 
...
print("template_function_F6f_tmm_2d_pca.R #########################################################################")
...
var_F6f_tmm_2d_pca<-F6f_tmm_2d_pca(var_DC_CPM_TMM_FILTERED,var_DC_metadata)
invisible(graphics.off())
saveRDS(var_F6f_tmm_2d_pca, paste0(rds_output,"/var_F6f_tmm_2d_pca.rds"))
